        ...
        btnParse.setOnClickListener(new View.OnClickListener() {
            ...
            private void parseXML() {
                try {
                    ...
                    parser.setInput(myinput, null); // Bổ sung dòng này!
                        ...
                        switch (eventType){
                            case XmlPullParser.START_TAG:
                                ...
                                if(nodeName.equalsIgnoreCase("employee")){
                                    ...
                                    parser.next(); // Phải next để tới TEXT
                                    datashow+=parser.getText()+"-";
                                }
                                else if(nodeName.equals("phone")){
                                    parser.next(); // Cũng phải next để đọc nội dung
                                    datashow+=parser.getText()+"-";
                                }
                                break;
                    ...
                    myadapter.notifyDataSetChanged(); // Chỉ gọi 1 lần khi xong
