        ...
        tab.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String tabId) {
                if(tabId.equalsIgnoreCase("t1")){
                    lst1.clear();
                    lst1.add(new Item("52300","Em của ngày hôm qua",0 ));
                    lst1.add(new Item("52600", "Chạy ngay đi",1));
                    adapter1.notifyDataSetChanged();
                }
                if(tabId.equalsIgnoreCase("t2")){
                    lst2.clear();
                    lst2.add(new Item("57236", "Chìm sâu", 1));
                    lst2.add(new Item("51548", "MOIEM", 0));
                    adapter2.notifyDataSetChanged();
                }
                if(tabId.equalsIgnoreCase("t3")){
                    lst3.clear();
                    lst3.add(new Item("57689","Hát với dòng sông",1));
                    lst3.add(new Item("58716", "Say tình - remix",1));
